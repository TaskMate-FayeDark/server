...
We received a request to reset the password for your account. To proceed, please select code below and enter it on the reset password page:

${dataBoardPasswordResetCode.code}
